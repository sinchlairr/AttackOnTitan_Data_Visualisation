...
function Clouder(params) {
    ...
    function setClosest(obj) {
        ...
        if (closest != null) {
            closest.span.style.color="black";
        } // if
        // closest = obj;
    ...
    function step(o, angle) {
        var x = o.x;
        var z = o.z;
        o.x = x * Math.cos(angle) - z * Math.sin(angle)+0.1;
        o.z = x * Math.sin(angle) + z * Math.cos(angle)+0.1;
    } // step
    ...
    function parametrize(p) {
        ...
        fontSize = p.fontSize ? p.fontSize : 1000;  //fontsizer
        fontShift = typeof(p.fontShift) != "undefined" ? p.fontShift : fontSize / 9;
        colorMax = p.colorMax ? parseColor(p.colorMax) : parseColor("#000000");
        colorMin = p.colorMin ? parseColor(p.colorMin) : parseColor("#000000");
